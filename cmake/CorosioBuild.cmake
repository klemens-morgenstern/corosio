...
macro(corosio_resolve_deps)
    ...
    if(BOOST_COROSIO_IS_ROOT
        ...
        # The example/beast/ target depends on Boost::beast (and asio).
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/example/beast/CMakeLists.txt")
            list(APPEND BOOST_INCLUDE_LIBRARIES beast asio)
        endif()
